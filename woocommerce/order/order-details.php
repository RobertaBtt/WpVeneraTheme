...
<div class="section-wrapper">
  <div class="container">
<h2 class="header-lined"><i class="icon-file-text-alt"></i> <?php _e( 'Order Details', 'woocommerce' ); ?></h2>
...
<header>
  <h2><i class="icon-user"></i> <?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
...
<?php endif; ?>
    <div class="box-wrapper">
    <header class="title">
      <h3><i class="icon-credit-card"></i> <?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
    </header>
    <address><p>
      <?php
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
  ...
  <div class="col-2">
    <div class="box-wrapper">
    <header class="title">
      <h3><i class="icon-truck"></i> <?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
    </header>
    <address><p>
      <?php
