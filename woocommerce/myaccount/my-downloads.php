...
<div class="section-wrapper">
  <div class="container">
  <h2 class="header-lined"><i class="icon-cloud-download"></i> <?php echo apply_filters( 'woocommerce_my_account_my_downloads_title', __( 'Available downloads', 'woocommerce' ) ); ?></h2>
