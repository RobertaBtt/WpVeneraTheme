...
if($element == 'wpb_tour') $output .= '<div class="wpb_tour_tabs_i">';
$output .= "\n\t\t\t".$tabs_nav;
$output .= "\n\t\t\t".wpb_js_remove_wpautop($content);
if($element == 'wpb_tour') $output .= '</div>';
if ( 'vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="'.__('Previous slide', 'js_composer').'" class="btn btn-mini btn-primary"><i class="icon-chevron-left"></i> '.__('Previous slide', 'js_composer').'</a></span> <span class="wpb_next_slide"><a href="#next" title="'.__('Next slide', 'js_composer').'" class="btn btn-mini btn-primary">'.__('Next slide', 'js_composer').' <i class="icon-chevron-right"></i></a></span></div>';
}
