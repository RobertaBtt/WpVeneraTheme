<?php
    ...
    $scheme[ 'navbarBackground' ]                = '#3A5363'; //596a72
    $scheme[ 'navbarBackgroundHighlight' ]       = '#3A5363';
    $scheme[ 'navbarBackgroundImage' ]           = 'none';
    $scheme[ 'navbarText' ]                      = '#fff';
    $scheme[ 'navbarLinkColor' ]                 = '#fff';
    $scheme[ 'navbarShadow' ]                    = 'none';
    $scheme[ 'navbarTopBorder' ]                 = '4px solid #3A5363';
    $scheme[ 'navbarBottomBorder' ]              = '4px solid #3A5363';
    $scheme[ 'navbarSearchColor' ]               = '#6B8493';
    ...
    // LEADER SECTION
    $scheme[ 'leaderBackground' ]                = '#68B3AF';
    $scheme[ 'leaderBackgroundImage' ]           = 'url("'. CSS_IMAGES_PATH .'blurred/triangles.png")';
    $scheme[ 'leaderMainHeaderWeight' ]          = '700';
    $scheme[ 'leaderTextColor' ]                 = '#fff';
    $scheme[ 'leaderSecondaryTextColor' ]        = '#cae0df';
    $scheme[ 'leaderHighlightColor' ]            = '#EAE3E7';
    ...
    $scheme[ 'accentBackground' ]                = '#556270';
    $scheme[ 'accentBackgroundHighlight' ]       = '#556270';
    $scheme[ 'accentIconsColor' ]                = '#fff';
    $scheme[ 'accentHeadingColor' ]              = '#fff';
    $scheme[ 'accentTextColor' ]                 = '#cbd0da';
