<?php
    ...
    // LEADER SECTION
    $scheme[ 'leaderBackground' ]                = '#4a88ac';
    $scheme[ 'leaderBackgroundImage' ]           = 'url("'. CSS_IMAGES_PATH .'blurred/triangles-blue.png")';
    ...
    $scheme[ 'accentIconsColor' ]                = '#B4BEC4';
    $scheme[ 'accentHeadingColor' ]              = '#fff';
    $scheme[ 'accentTextColor' ]                 = '#D2D9DD';
    ...
    $scheme[ 'btnWarningBackground' ]            = '#d3ba44';
    ...
    $scheme[ 'btnSuccessBackground' ]            = '#9DB548';
    ...
    $scheme[ 'postContentBorder' ]               = 'none';
    $scheme[ 'postContentBackground' ]           = '#fff';
    $scheme[ 'postContentBackgroundHighlight' ]  = '#fff';
    $scheme[ 'postContentShadow' ]               = 'none';
    ...
    // POST META
    $scheme[ 'postMetaRadius' ]                  = '0px';
    $scheme[ 'postMetaPadding' ]                 = '0px 0px 10px 0px';
    $scheme[ 'postMetaBackground' ]              = '#fff';
    $scheme[ 'postMetaBackgroundHighlight' ]     = $scheme['postMetaBackground'];
    $scheme[ 'postMetaBorder' ]                  = 'none';
    ...
    $scheme[ 'postMetaShadow' ]                  = '0px 1px 0px 0px '.$this->adjustBrightness( $scheme[ 'postMetaBackground' ], -20 );;
    // POST ENTRY TAG
    $scheme[ 'postEntryTagColor' ]               = '#fff';
    $scheme[ 'postEntryTagBackground' ]          = '#3679A0';
    $scheme[ 'postEntryTagBorder' ]              = '1px solid '.$this->adjustBrightness( $scheme[ 'postEntryTagBackground' ], -30 );
    $scheme[ 'postEntryTagShadow' ]              = '0px 2px 2px '.$this->adjustBrightness( $scheme[ 'postMetaBackground' ], -20 );
    $scheme[ 'postEntryTagRadius' ]              = '0px';
    ...
    $scheme[ 'preFooterBackground' ]                 = '#2A98C7';
    ...
    $scheme[ 'wooLoopProductBackground' ]                   = '#fff';
    $scheme[ 'wooLoopProductBackgroundHighlight' ]          = '#fff';
    $scheme[ 'wooLoopProductBackgroundHover' ]              = '#fff';
    $scheme[ 'wooLoopProductPadding' ]                      = '15px';
    $scheme[ 'wooLoopProductShadow' ]                       = 'none';
    $scheme[ 'wooLoopProductShadowHover' ]                  = 'none';
    $scheme[ 'wooLoopProductRadius' ]                       = 'none';
    $scheme[ 'wooLoopProductBorder' ]                       = 'none';
    ...
    $scheme[ 'wooSidebarBackgroundHighlight' ]              = '#D5DEE2';
    $scheme[ 'wooSidebarRadius' ]                           = '0px';
    $scheme[ 'wooSidebarBorder' ]                           = 'none';
    $scheme[ 'wooSidebarShadow' ]                           = 'inset 3px 0px 4px 0px #C2CED3';
