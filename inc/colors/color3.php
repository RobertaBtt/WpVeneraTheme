<?php
    // BASE SETTINGS
    $scheme[ 'bodyBackground' ]                  = '#ebede3';
    $scheme[ 'textColor' ]                       = '#4f4e4c';
    $scheme[ 'headingsColor' ]                   = '#3d3b36';
    ...
    $scheme[ 'headingsBorder' ]                  = '3px solid '. $this->adjustBrightness( $scheme[ 'bodyBackground' ], -10 );
    $scheme[ 'headingsShadow' ]                  = '0px 1px 0px ' . $this->adjustBrightness( $scheme[ 'bodyBackground' ], -40 ) . ', 0px 3px 0px 0px '. $this->adjustBrightness( $scheme[ 'bodyBackground' ], 20 );
    ...
    $scheme[ 'navbarBackground' ]                = '#ebede4'; //596a72
    $scheme[ 'navbarBackgroundHighlight' ]       = '#ebede4';
    $scheme[ 'navbarBackgroundImage' ]           = 'none';
    $scheme[ 'navbarText' ]                      = '#53564e';
    $scheme[ 'navbarLinkColor' ]                 = '#53564e';
    $scheme[ 'navbarShadow' ]                    = 'none';
    $scheme[ 'navbarTopBorder' ]                 = '4px solid #f5f6ef';
    $scheme[ 'navbarBottomBorder' ]              = '4px solid #f5f6ef';
    ...
    $scheme[ 'navbarLinkBackgroundActive' ]      = '#dce0cf';
    ...
    // HIGHLIGHTED HEADER
    $scheme[ 'highlightedHeaderBackground' ]     = '#74a19e'; // #556270 // #76a3a0  // #7C9495  // #AFC1A8  // #51606c
    $scheme[ 'highlightedHeaderBackgroundImage' ]= 'url("'. CSS_IMAGES_PATH .'blurred/noise-green.jpg")';
    $scheme[ 'highlightedHeaderHeadingColor' ]   = '#ffffff';
    $scheme[ 'highlightedHeaderSubHeadingColor' ]= '#BAD1CF';
    $scheme[ 'highlightedHeaderShadow' ]         = 'inset 0px -2px 5px 0px rgba(0,0,0,0.3), 0px 4px 1px 0px ' . $this->adjustBrightness( $scheme[ 'bodyBackground' ], 30 );
    $scheme[ 'highlightedHeaderTextShadow' ]     = '2px 2px 0px rgba(0,0,0,0.3)';

    // LEADER SECTION
    $scheme[ 'leaderBackground' ]                = '#74a19e';
    $scheme[ 'leaderBackgroundImage' ]           = 'url("'. CSS_IMAGES_PATH .'blurred/noise-green.jpg")';
    $scheme[ 'leaderMainHeaderWeight' ]          = '700';
    $scheme[ 'leaderTextColor' ]                 = '#fff';
    $scheme[ 'leaderSecondaryTextColor' ]        = '#bdd3d2';
    $scheme[ 'leaderHighlightColor' ]            = '#ffecb0';
    ...
    $scheme[ 'accentBackground' ]                = '#6c7065';
    $scheme[ 'accentBackgroundHighlight' ]       = '#6c7065';
    $scheme[ 'accentIconsColor' ]                = '#fff';
    $scheme[ 'accentHeadingColor' ]              = '#fff';
    $scheme[ 'accentTextColor' ]                 = '#b8bbb3';
    $scheme[ 'accentIconsTextShadow' ]           = '0px 4px 0px rgba(0,0,0,0.3)';
    $scheme[ 'accentBorders' ]                   = '2px solid '.$this->adjustBrightness( $scheme[ 'accentBackground' ], -10 );
    $scheme[ 'accentShadow' ]                    = '0px -10px 2px 0px rgba(0,0,0,0.2), 0px 5px 2px 0px ' . $this->adjustBrightness( $scheme[ 'bodyBackground' ], 50 ) . ', inset 0px 3px 2px 0px ' . $this->adjustBrightness( $scheme[ 'accentBackground' ], 10 );
    ...
    // CTA BLOCK
    $scheme[ 'standoutBackground' ]              = '#6c7065';
    ...
    $scheme[ 'standoutHeadingsBorder' ]          = '3px solid '. $this->adjustBrightness( $scheme[ 'standoutBackground' ], -50 );
    ...
    // ITEM BOX
    $scheme[ 'framedPostBackground' ]            = '#fdfdfb';
    $scheme[ 'framedPostBackgroundHighlight' ]   = '#fafaf4';
    $scheme[ 'framedPostBackgroundHover' ]       = '#fff';
    $scheme[ 'framedPostBorder' ]                = 'none';
    $scheme[ 'framedPostRadius' ]                = '6px';
    $scheme[ 'framedPostPadding' ]               = '15px';
    $scheme[ 'framedPostHeadingColor' ]          = '#494642';
    $scheme[ 'framedPostTextColor' ]             = '#56534e';
    $scheme[ 'framedPostShadow' ]                = '0px 2px 4px 1px rgba(0,0,0,0.15), inset 2px 2px 3px 0px #fcfcfc';
    ...
    $scheme[ 'testimonialBubbleRadius' ]         = '5px';
    ...
    $scheme[ 'testimonialBubbleShadow' ]         = '0px 2px 10px 1px rgba(0,0,0,0.15), inset 2px 2px 3px 0px #fff';
    $scheme[ 'testimonialAuthorShadow' ]         = '3px 3px 0px 0px rgba(0,0,0,0.15)';
    $scheme[ 'testimonialAuthorShadowFaded' ]    = '-3px -3px 0px 0px rgba(0,0,0,0.15)';
    // ACCORDION
    ...
    $scheme[ 'pricingPackageShadow' ]            = '0px 0px 10px 0px rgba(0,0,0,0.3)';
    $scheme[ 'pricingPackageRadius' ]            = '8px';

    // BUTTONS
    $scheme[ 'btnBorderRadius' ]                 = '6px';
    $scheme[ 'btnBorderRadiusSmall' ]            = '4px';
    $scheme[ 'btnBorderRadiusLarge' ]            = '8px';
    $scheme[ 'btnBorderRadiusHuge' ]             = '8px';
    $scheme[ 'btnType' ]                         = 'default';
    // DEFAULT BUTTON
    ...
    // BROWSER FRAME
    $scheme[ 'browserBackground' ]               = '#f6f4ee';
    ...
    $scheme[ 'browserShadow' ]                   = '0px 2px 12px 1px rgba(0,0,0,0.25), inset 0px 0px 3px 2px '.$this->adjustBrightness( $scheme[ 'browserBackground' ], 30 );
    ...
    $scheme[ 'wooSidebarBackgroundHighlight' ]              = '#CECDC8';
